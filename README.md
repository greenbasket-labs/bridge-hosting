...
Completed: **customer administration, application administration, provider resource view, deployment operations dashboard, failed deployment queue, and health/outage dashboard.**

Next task: **usage overview — give operators a compact view of resource consumption and plan usage across applications.**
