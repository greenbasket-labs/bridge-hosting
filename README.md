...
Completed: **customer administration, application administration, provider resource view, deployment operations dashboard, failed deployment queue, health/outage dashboard, usage overview, resource capacity overview, and provider configuration management.**

Next task: **audit log viewer — give operators a minimal read-only view of recent operational and customer-account events.**
